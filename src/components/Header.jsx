...
function Header() {
  ...
  return (
    <>
    {
      isOpen&&(
        <>
        <div className=" md:hidden bg-zinc-800 rounded-2xl  border top-15 right-0 text-white  fixed flex z-10 flex-col gap-3 p-5">
  ...
  <Link target='_blank' href="https://github.com/mohamedwael56?tab=repositories">Visit github</Link>
    ...
    <header className="flex fixed z-10 justify-center p-1  ">
